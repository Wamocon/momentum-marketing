...
ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "users_requested_plan_id_fkey" FOREIGN KEY ("requested_plan_id") REFERENCES "public"."plans"("id") ON DELETE SET NULL;
...
CREATE INDEX "ai_generation_log_company_id_idx" ON "public"."ai_generation_log" USING "btree" ("company_id");
...
CREATE INDEX "ai_generation_log_created_at_idx" ON "public"."ai_generation_log" USING "btree" ("created_at");
...
CREATE INDEX "ai_generation_log_task_id_idx" ON "public"."ai_generation_log" USING "btree" ("task_id");
...
CREATE INDEX "audiences_company_id_idx" ON "public"."audiences" USING "btree" ("company_id");
...
CREATE INDEX "connected_accounts_company_id_idx" ON "public"."connected_accounts" USING "btree" ("company_id");
...
CREATE INDEX "connected_accounts_platform_idx" ON "public"."connected_accounts" USING "btree" ("platform");
...
CREATE INDEX "contents_company_id_idx" ON "public"."contents" USING "btree" ("company_id");
...
CREATE INDEX "engagement_metrics_pulled_at_idx" ON "public"."engagement_metrics" USING "btree" ("pulled_at");
...
CREATE INDEX "engagement_metrics_scheduled_post_id_idx" ON "public"."engagement_metrics" USING "btree" ("scheduled_post_id");
...
CREATE INDEX "idx_scheduled_posts_company_campaign" ON "public"."scheduled_posts" USING "btree" ("company_id", "campaign_id");
...
CREATE INDEX "idx_scheduled_posts_company_platform" ON "public"."scheduled_posts" USING "btree" ("company_id", "platform");
...
CREATE INDEX "idx_scheduled_posts_company_status" ON "public"."scheduled_posts" USING "btree" ("company_id", "status");
...
CREATE INDEX "idx_scheduled_posts_status_scheduled" ON "public"."scheduled_posts" USING "btree" ("status", "scheduled_at") WHERE ("status" = ANY (ARRAY['approved'::"text", 'scheduled'::"text"]));
...
CREATE INDEX "ix_test_socialhub_app_logs_timestamp" ON "public"."socialhub_app_logs" USING "btree" ("timestamp" DESC);
...
CREATE INDEX "ix_test_socialhub_posts_created_at" ON "public"."socialhub_posts" USING "btree" ("created_at" DESC);
...
CREATE INDEX "ix_test_socialhub_posts_platform" ON "public"."socialhub_posts" USING "btree" ("platform");
...
CREATE INDEX "ix_test_socialhub_posts_platform_status_created_at" ON "public"."socialhub_posts" USING "btree" ("platform", "status", "created_at" DESC);
...
CREATE INDEX "ix_test_socialhub_posts_scheduled_for" ON "public"."socialhub_posts" USING "btree" ("scheduled_for");
...
CREATE INDEX "ix_test_socialhub_posts_status" ON "public"."socialhub_posts" USING "btree" ("status");
...
CREATE INDEX "ix_test_socialhub_posts_status_created_at" ON "public"."socialhub_posts" USING "btree" ("status", "created_at" DESC);
...
CREATE INDEX "ix_test_socialhub_posts_topic" ON "public"."socialhub_posts" USING "btree" ("topic");
...
CREATE INDEX "ix_test_socialhub_topic_ideas_created_at" ON "public"."socialhub_topic_ideas" USING "btree" ("created_at" DESC);
...
CREATE INDEX "journeys_company_id_idx" ON "public"."journeys" USING "btree" ("company_id");
...
CREATE INDEX "knowledge_documents_company_id_idx" ON "public"."knowledge_documents" USING "btree" ("company_id");
...
CREATE INDEX "knowledge_documents_embedding_idx" ON "public"."knowledge_documents" USING "hnsw" ("embedding" "public"."vector_cosine_ops") WITH ("m"='16', "ef_construction"='64');
...
CREATE INDEX "scheduled_posts_company_id_idx" ON "public"."scheduled_posts" USING "btree" ("company_id");
...
CREATE INDEX "scheduled_posts_connected_account_id_idx" ON "public"."scheduled_posts" USING "btree" ("connected_account_id");
...
CREATE INDEX "scheduled_posts_scheduled_at_idx" ON "public"."scheduled_posts" USING "btree" ("scheduled_at");
...
CREATE INDEX "scheduled_posts_status_idx" ON "public"."scheduled_posts" USING "btree" ("status");
...
CREATE INDEX "touchpoints_company_id_idx" ON "public"."touchpoints" USING "btree" ("company_id");
...
CREATE INDEX "usage_records_company_id_period_start_period_end_idx" ON "public"."usage_records" USING "btree" ("company_id", "period_start", "period_end");
...
ALTER TABLE ONLY "public"."subscriptions"
    ADD CONSTRAINT "fk_subscriptions_company" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;
