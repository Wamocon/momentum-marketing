...
INSERT INTO "public"."users" ("id", "name", "email", "password", "role", "job_title", "avatar", "status", "department", "phone", "joined_at", "created_at", "updated_at", "is_super_admin", "is_active") VALUES
...
SELECT pg_catalog.setval('"public"."socialhub_app_logs_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."socialhub_instagram_accounts_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."socialhub_linkedin_accounts_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."socialhub_posts_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."socialhub_topic_ideas_id_seq"', 1, false);
